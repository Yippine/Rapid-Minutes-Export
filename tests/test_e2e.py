...
class TestE2EWorkflow:
    ...
    async def test_processing_pipeline_mock(self, sample_meeting_transcript):
        ...
        from app.ai.extractor import StructuredDataExtractor, MeetingMinutes
        ...
        with patch.object(StructuredDataExtractor, 'extract_meeting_minutes') as mock_extract:
            from app.ai.extractor import MeetingBasicInfo, Attendee, DiscussionTopic, ActionItem, Decision, ExtractionResult, ExtractionStatus
