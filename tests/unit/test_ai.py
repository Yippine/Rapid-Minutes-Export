...
from src.rapid_minutes.ai.text_preprocessor import TextPreprocessor, PreprocessedText
from src.rapid_minutes.ai.ollama_client import OllamaClient, GenerationResponse
from src.rapid_minutes.ai.extractor import StructuredDataExtractor, MeetingMinutes, ExtractionStatus
...
class TestStructuredDataExtractor:
    ...
    def test_confidence_calculation(self, extractor):
        ...
        from src.rapid_minutes.ai.extractor import MeetingBasicInfo, Attendee, DiscussionTopic, ActionItem, Decision
